...
! video/x-raw,format=NV12, width=1280, height=800 ! queue ! tiperfoverlay title="Phycam VM-016 Keypoint Detection" ! kmssink driver-name=tidss sync=true connector-id=40
