...
SRCREV = "d396d6fb5debec8c078a8fce909818ff623268fb"
...
EXTRA_OECMAKE = "-DTARGET_FS=${WORKDIR}/recipe-sysroot -DCMAKE_SKIP_RPATH=TRUE -DCMAKE_OUTPUT_DIR=${WORKDIR}/out -DUSE_DLR_RT=OFF"
