...
FW_TYPE:edgeai = "vision_apps_eaik"
FW_TYPE:adas = "vision_apps_evm"

FW_DIR = "${PLAT_SFX}/${FW_TYPE}"
INSTALL_FW_DIR = "${nonarch_base_libdir}/firmware/${FW_TYPE}/"
...
ALTERNATIVE_TARGET[j7-mcu-r5f0_1-fw] = "${FW_TYPE}/${MCU_1_1_FW}"
ALTERNATIVE_TARGET[j7-main-r5f0_0-fw] = "${FW_TYPE}/${MCU_2_0_FW}"
ALTERNATIVE_TARGET[j7-main-r5f0_1-fw] = "${FW_TYPE}/${MCU_2_1_FW}"
ALTERNATIVE_TARGET[j7-main-r5f1_0-fw] = "${FW_TYPE}/${MCU_3_0_FW}"
ALTERNATIVE_TARGET[j7-main-r5f1_1-fw] = "${FW_TYPE}/${MCU_3_1_FW}"
ALTERNATIVE_TARGET[j7-c66_0-fw] = "${FW_TYPE}/${C66_1_FW}"
ALTERNATIVE_TARGET[j7-c66_1-fw] = "${FW_TYPE}/${C66_2_FW}"
ALTERNATIVE_TARGET[j7-c71_0-fw] = "${FW_TYPE}/${C7X_1_FW}"

ALTERNATIVE_TARGET[j7-main-r5f0_0-fw-sec] = "${FW_TYPE}/${MCU_2_0_FW}.signed"
ALTERNATIVE_TARGET[j7-main-r5f0_1-fw-sec] = "${FW_TYPE}/${MCU_2_1_FW}.signed"
ALTERNATIVE_TARGET[j7-main-r5f1_0-fw-sec] = "${FW_TYPE}/${MCU_3_0_FW}.signed"
ALTERNATIVE_TARGET[j7-main-r5f1_1-fw-sec] = "${FW_TYPE}/${MCU_3_1_FW}.signed"
ALTERNATIVE_TARGET[j7-c66_0-fw-sec] = "${FW_TYPE}/${C66_1_FW}.signed"
ALTERNATIVE_TARGET[j7-c66_1-fw-sec] = "${FW_TYPE}/${C66_2_FW}.signed"
ALTERNATIVE_TARGET[j7-c71_0-fw-sec] = "${FW_TYPE}/${C7X_1_FW}.signed"

ALTERNATIVE_TARGET[j721s2-mcu-r5f0_1-fw] = "${FW_TYPE}/${MCU_1_1_FW}"
ALTERNATIVE_TARGET[j721s2-main-r5f0_0-fw] = "${FW_TYPE}/${MCU_2_0_FW}"
ALTERNATIVE_TARGET[j721s2-main-r5f0_1-fw] = "${FW_TYPE}/${MCU_2_1_FW}"
ALTERNATIVE_TARGET[j721s2-main-r5f1_0-fw] = "${FW_TYPE}/${MCU_3_0_FW}"
ALTERNATIVE_TARGET[j721s2-main-r5f1_1-fw] = "${FW_TYPE}/${MCU_3_1_FW}"
ALTERNATIVE_TARGET[j721s2-c71_0-fw] = "${FW_TYPE}/${C7X_1_FW}"
ALTERNATIVE_TARGET[j721s2-c71_1-fw] = "${FW_TYPE}/${C7X_2_FW}"

ALTERNATIVE_TARGET[j721s2-main-r5f0_0-fw-sec] = "${FW_TYPE}/${MCU_2_0_FW}.signed"
ALTERNATIVE_TARGET[j721s2-main-r5f0_1-fw-sec] = "${FW_TYPE}/${MCU_2_1_FW}.signed"
ALTERNATIVE_TARGET[j721s2-main-r5f1_0-fw-sec] = "${FW_TYPE}/${MCU_3_0_FW}.signed"
ALTERNATIVE_TARGET[j721s2-main-r5f1_1-fw-sec] = "${FW_TYPE}/${MCU_3_1_FW}.signed"
ALTERNATIVE_TARGET[j721s2-c71_0-fw-sec] = "${FW_TYPE}/${C7X_1_FW}.signed"
ALTERNATIVE_TARGET[j721s2-c71_1-fw-sec] = "${FW_TYPE}/${C7X_2_FW}.signed"

ALTERNATIVE_TARGET[j784s4-mcu-r5f0_1-fw] = "${FW_TYPE}/${MCU_1_1_FW}"
ALTERNATIVE_TARGET[j784s4-main-r5f0_0-fw] = "${FW_TYPE}/${MCU_2_0_FW}"
ALTERNATIVE_TARGET[j784s4-main-r5f0_1-fw] = "${FW_TYPE}/${MCU_2_1_FW}"
ALTERNATIVE_TARGET[j784s4-main-r5f1_0-fw] = "${FW_TYPE}/${MCU_3_0_FW}"
ALTERNATIVE_TARGET[j784s4-main-r5f1_1-fw] = "${FW_TYPE}/${MCU_3_1_FW}"
ALTERNATIVE_TARGET[j784s4-main-r5f2_0-fw] = "${FW_TYPE}/${MCU_4_0_FW}"
ALTERNATIVE_TARGET[j784s4-main-r5f2_1-fw] = "${FW_TYPE}/${MCU_4_1_FW}"
ALTERNATIVE_TARGET[j784s4-c71_0-fw] = "${FW_TYPE}/${C7X_1_FW}"
ALTERNATIVE_TARGET[j784s4-c71_1-fw] = "${FW_TYPE}/${C7X_2_FW}"
ALTERNATIVE_TARGET[j784s4-c71_2-fw] = "${FW_TYPE}/${C7X_3_FW}"
ALTERNATIVE_TARGET[j784s4-c71_3-fw] = "${FW_TYPE}/${C7X_4_FW}"

ALTERNATIVE_TARGET[am62a-mcu-r5f0_0-fw] = "${FW_TYPE}/${MCU_1_0_FW}"
ALTERNATIVE_TARGET[am62a-c71_0-fw] = "${FW_TYPE}/${C7X_1_FW}"

ALTERNATIVE_TARGET[am62a-mcu-r5f0_0-fw-sec] = "${FW_TYPE}/${MCU_1_0_FW}.signed"
ALTERNATIVE_TARGET[am62a-c71_0-fw-sec] = "${FW_TYPE}/${C7X_1_FW}.signed"
